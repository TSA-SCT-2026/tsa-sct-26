...
- MECHANICAL.md -- physical design, all measurements, CAD structure, fabrication order and concerns
- ELECTRICAL.md -- power architecture, wiring, protection components, failure modes to avoid
- EMBEDDED.md -- state machine, sensor logic, actuator control, display, thermal model, firmware checklist
