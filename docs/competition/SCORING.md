...
> Raw official event document pasted verbatim below. The notes section above the raw text is the important part to internalize before reading it.

## What matters most

**The scoring split is: Inventor's Log (20) / Solution to Problem (60) / Programming Structure (20).**

The device working is 60% of the score. This is the dominant category. Reliability and accuracy matter more than speed. Speed is a factor within this category but is the tiebreaker at the top of the field, not the primary objective.
...
**15-minute setup.** The system must be fully operational with no calibration after being placed and powered. Everything is locked in before conference day.
