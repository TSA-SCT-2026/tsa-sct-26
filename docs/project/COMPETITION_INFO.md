...
- "At least two sensors" must be satisfied by the final states sensor set. The active plan already includes color sensing and an undecided size sensor, so document the final choice before competition.
