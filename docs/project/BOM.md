...
|------|----------------|-----|
| Visual conveyor tutorial | Needed now, no purchase if free | Use as the primary conveyor construction reference so the CAD and bench build stay beginner-followable. |
...
| Wood frame and support-block stock | Needed from Home Depot or equivalent local hardware store | The active frame and conveyor support are wood, not 2020 extrusion. Confirm available block dimensions before frame CAD drifts. |
...
## Dropped From Active Buying Gate

| Item | Status | Why |
|------|--------|-----|
| 4-Pack 2020 Aluminum Extrusion 400mm | Dropped for states | Replaced by a wood block support and wood frame to match the tutorial-style conveyor path. Do not buy unless physical testing shows the wood block cannot stay flat enough. |
