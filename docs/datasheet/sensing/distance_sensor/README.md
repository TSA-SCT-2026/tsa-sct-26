...
Active status: archived candidate only. Not active for the states size sensor unless the user explicitly reopens it.
...
| States-build use | Not active for states size sensing |
| Trust level | CAD assets and images stored in this folder |
| Date checked | 2026-04-08 |
| CAD-ready | Preliminary only |
| Next action | Do not choose ToF unless the user explicitly reopens the size sensor decision |
...
- Distance sensing is not active for the states size sensor.
- Do not treat the old dual rear-wall chamber layout as active.
- If this sensor family is explicitly reopened, define a conveyor-mounted bracket and calibration method in `docs/project/OPEN_DECISIONS.md` before final CAD.
