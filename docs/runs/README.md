...
- `run_id,brick,state,ts_state_ms,ts_entry_ms,ts_seated_ms,ts_sensed_ms,ts_selector_ready_ms,ts_release_ms,ts_bin_confirm_ms,ts_platform_level_ms,ts_chamber_clear_ms,ts_pitch_advance_ms,category,size,color,target_bin,actual_bin,samples,selector_index_steps,selector_index_ms,solenoid_on_ms,thermal_state,error_code`
