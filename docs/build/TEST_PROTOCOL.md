...
### Phase 0: Mechanical Dry Fit

Run this phase before permanent wood cuts, fixed-height feet, or final handoff parts.

Pass criteria:
- Conveyor belt tracks without rubbing.
- Motor and pulley adjustment remain serviceable.
- Support parts do not interfere with the return path.
- Sensing shroud and side rails do not catch real bricks.
- Belt exit, chute entry, chute exit, and bin catch height are checked together.
- No permanent hole pattern depends on unresolved bin geometry.
